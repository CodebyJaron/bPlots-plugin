...
public class AddMemberCommand extends PlotSubCommand {
    private String permission;

    public AddMemberCommand(String name, String defaultDescription, String defaultUsage, String defaultPermission) {
    ...
    public boolean onCommand(Player player, ProtectedRegion region, String label, String[] args) throws Exception {
        ...
        player.sendMessage(messages.get(Message.PLOT_ADD_MEMBER,
                Placeholder.of("PlotName", region.getId()), Placeholder.of("NewMember", target.getName())));
